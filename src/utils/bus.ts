/**
 * Bus: Tiny functional event emitter / pubsub
 *
 * @name Bus
...
export default class Bus {
     ...
     */
    public emit(type: string | Symbol, evt?: any) {
     ...
     *
     * Note: This will also remove event handlers passed via `Bus(all: EventHandlerMap)`.
     */
    clear() {
        this.cache.clear();
    }
