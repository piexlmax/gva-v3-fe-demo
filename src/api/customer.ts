...
export const createExaCustomer = (data: any) => {
    return service({
...
export const updateExaCustomer = (data: any) => {
    return service({
        url: "/customer/customer",
        method: 'put',
        data
...
export const deleteExaCustomer = (data: any) => {
    return service({
        url: "/customer/customer",
        method: 'delete',
        data
...
export const getExaCustomer = (params: any) => {
    return service({
        url: "/customer/customer",
        method: 'get',
        params
...
export const getExaCustomerList = (params: any) => {
    return service({
